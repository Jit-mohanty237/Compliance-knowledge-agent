from services.memory import get_session_history, add_message_to_session, create_session
from compliance_agent import run_compliance_query
import sys
...
def process_compliance_chat(query: str, session_id: str = None) -> tuple[dict, str]:
    ...
    add_message_to_session(session_id, role="assistant",
                           content=res_dict["answer"])
